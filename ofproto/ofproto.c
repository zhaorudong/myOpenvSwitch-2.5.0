...
{
   //WriteC_ofproto(__FILE__,__func__,__LINE__);
    ...
    OVS_EXCLUDED(ofproto_mutex)
{
	...
	//WriteC_ofproto(__FILE__,__func__,__LINE__);
	fs.first_DPID=rule->cr.first_DPID;
    ...
    OVS_REQUIRES(ofproto_mutex)
{
    ...
    cls_rule_init2(&cr, &fm->match, fm->priority,fm->first_DPID);
    //WriteC_ofproto(__FILE__,__func__,cr.first_DPID);
    ...
    OVS_EXCLUDED(ofproto_mutex)
{
   ...
   fr.first_DPID=rule->cr.first_DPID;
   //WriteC_ofproto(__FILE__,__func__,__LINE__);
    ovs_mutex_lock(&ofproto_mutex);
    ...
    OVS_REQUIRES(ofproto_mutex)
{
    ...
    fu.first_DPID=rule->cr.first_DPID;
